...
public class LinearReferenceCalculator {
    private static org.neo4j.spatial.algo.cartesian.LinearReference cartesian;
    private static org.neo4j.spatial.algo.wgs84.LinearReference wgs84;

    private static LinearReference getCartesian() {
        if (cartesian == null) {
            cartesian = new org.neo4j.spatial.algo.cartesian.LinearReference();
        }
        return cartesian;
    }
    ...
    private static LinearReference getWGS84() {
        if (wgs84 == null) {
            wgs84 = new org.neo4j.spatial.algo.wgs84.LinearReference();
        }
        return wgs84;
    }
