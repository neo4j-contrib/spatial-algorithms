...
Otherwise simply copy the file named something like `dist/target/spatial-algorithms-dist-0.2.6-neo4j-5.13.0-SNAPSHOT.jar`
...
~~~xml
    ...
    <dependency>
        ...
        <version>0.2.6-neo4j-5.13.0-SNAPSHOT</version>
    </dependency>
    <dependency>
        <groupId>org.neo4j</groupId>
